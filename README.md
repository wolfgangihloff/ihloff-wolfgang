...
```
$ gatsby new ihloff-wolfgang-blog https://github.com/contentful/starter-gatsby-blog/
```
...
Feel free to open pull requests to fix bugs. If you want to add features, please have a look at the [original version](https://github.com/contentful-userland/gatsby-ihloff-wolfgang). It is always open to contributions and pull requests.
